 ...
 *      "This is a secondary, multiline, long text. This text usually extends
 *       the primary text and prints e.g: the details of an error.",
...
public class Granite.MessageDialog : Gtk.Dialog {
     ...
     *
     * This bin can be used to add any custom widget to the message area such as
     * a {@link Gtk.ComboBox} or {@link Gtk.CheckButton}.
     * Note that after adding such widget you will need to call {@link Gtk.Widget.show}
     * or {@link Gtk.Widget.show_all} on the widget itself for it to appear in the dialog.
     *
     * If you want to add multiple widgets to this area, create a new container
     * such as {@link Gtk.Grid} or {@link Gtk.Box} and then add it to the custom bin.
     *
     * When adding a custom widget to the custom bin, the
     * {@link Granite.MessageDialog.secondary_label}'s bottom margin will be
     * expanded automatically to compensate for the additional widget in the dialog.
     * Removing the previously added widget will remove the bottom margin.
     *
     * If you don't want to have any margin between your custom widget and the
     * {@link Granite.MessageDialog.secondary_label}, simply add your custom widget
     ...
     * @param buttons the {@link Gtk.ButtonsType} value that decides what buttons
     * to use, defaults to {@link Gtk.ButtonsType.CLOSE}, see
     * {@link Granite.MessageDialog.buttons} on details and what values are accepted
     */
